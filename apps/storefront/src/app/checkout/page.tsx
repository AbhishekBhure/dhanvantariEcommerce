...
type OrderResponse = { data: { orderId: string; orderNumber: string; total: number } };
...
export default function CheckoutPage() {
  ...
  async function placeOrder() {
    ...
    setIsSubmitting(true);
    try {
      const response = await api.post<OrderResponse>("/orders", { addressId: selectedAddressId, paymentMethod: "COD" });
